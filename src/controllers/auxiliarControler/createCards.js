//creamos una funcion para mostrar las cartas de los productos
const getProductCards=(products)=> {
    ...
    productsCard = `<div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">${htmlCard}</div>`;
    return productsCard;
  }

//Funcion auxilar que nos ayuda a pintar las cartas de todos los productos con las opciones de eliminar y modificar producto
const getDashboard = (products) => {
    ...
    productsCard = `<div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">${htmlCards}</div>`;
    return productsCard;
  }
  ...
  const getProductCardDashboard = (product) => {
    const html = `
    <div class="card">
      <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src="${product.imagen}" alt="${product.imagen}">
  ...
  module.exports = {getProductCards,getDashboard,getProductCard,getProductCardDashboard };